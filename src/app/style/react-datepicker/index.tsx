    ...
    "& .react-datepicker": {
      ...
      "&:not(.react-datepicker--time-only)": {
        "& .react-datepicker__time-container": {
          padding: theme.spacing(0.3, 0), // Adjust padding as needed
          fontSize: "0.75rem",
        ...
        ".react-datepicker-time__header": {
          paddingTop: theme.spacing(1.2), // Adjust padding as needed
          fontSize: "0.75rem", // Adjust font size as needed
        },
      },
      ...
      "& .react-datepicker__time-container": {
        ...
        "& .react-datepicker__time-list-item": {
          ...
          marginRight: theme.spacing(0.5), // Adjust margin as needed
          color: theme.palette.text.primary,
          borderRadius: theme.shape.borderRadius,
          fontSize: "0.725rem",
          "&:focus, &:active": {
